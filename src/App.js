  ...
  return (
    <div className="App">
      <form onSubmit={getSearch} className="search-form">
        <input placeholder="Enter a keyword to find your favorite food recipe eg. chicken, dosa etc" className="search-bar" type="text" value={search} onChange={updateSearch}/>
